...
**2025.10.05 - 19:23 PST (Los Angeles Time)**

- 🚀 **Performance Optimization by eddy**: Major performance and memory improvements
  - ⚡ **SageAttention Integration**: Added support for SageAttention, SageAttention3, and SageAttention3 FP4 (1038 TOPS on RTX 5090)
  - 🎯 **FP4 Quantization**: Experimental FP4 quantization support for extreme memory efficiency
  - 🔧 **Torch.Compile Integration**: Intelligent model compilation with automatic backend selection
  - 💾 **Stable Memory Management**: Predictable memory usage with memory pooling and pressure monitoring
  - 🎛️ **Advanced UI Controls**: New attention_mode and quantization parameters in ComfyUI node
  - 📊 **Expected Performance Gains**: 20-40% faster inference, 2-4x attention speedup, 30-50% memory reduction
...
- Original [SeedVR2](https://github.com/ByteDance-Seed/SeedVR) implementation by ByteDance
- Performance optimizations and advanced features by **eddy** (October 5, 2025)
